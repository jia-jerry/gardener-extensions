...
import (
	...
	config "github.com/gardener/gardener-extensions/controllers/provider-alicloud/pkg/apis/config"
...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*RegionImageMapping)(nil), (*config.RegionImageMapping)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_RegionImageMapping_To_config_RegionImageMapping(a.(*RegionImageMapping), b.(*config.RegionImageMapping), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.RegionImageMapping)(nil), (*RegionImageMapping)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_RegionImageMapping_To_v1alpha1_RegionImageMapping(a.(*config.RegionImageMapping), b.(*RegionImageMapping), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_config_ControllerConfiguration_To_v1alpha1_ControllerConfiguration(in *config.ControllerConfiguration, out *ControllerConfiguration, s conversion.Scope) error {
	...
	// WARNING: in.MachineImageOwnerSecretRef requires manual conversion: does not exist in peer-type
...
func autoConvert_v1alpha1_MachineImage_To_config_MachineImage(in *MachineImage, out *config.MachineImage, s conversion.Scope) error {
	...
	out.Regions = *(*[]config.RegionImageMapping)(unsafe.Pointer(&in.Regions))
	return nil
}
...
func autoConvert_config_MachineImage_To_v1alpha1_MachineImage(in *config.MachineImage, out *MachineImage, s conversion.Scope) error {
	out.Name = in.Name
	out.Version = in.Version
	out.Regions = *(*[]RegionImageMapping)(unsafe.Pointer(&in.Regions))
	return nil
}
...
func autoConvert_v1alpha1_RegionImageMapping_To_config_RegionImageMapping(in *RegionImageMapping, out *config.RegionImageMapping, s conversion.Scope) error {
	out.Region = in.Region
	out.ImageID = in.ImageID
	return nil
}

// Convert_v1alpha1_RegionImageMapping_To_config_RegionImageMapping is an autogenerated conversion function.
func Convert_v1alpha1_RegionImageMapping_To_config_RegionImageMapping(in *RegionImageMapping, out *config.RegionImageMapping, s conversion.Scope) error {
	return autoConvert_v1alpha1_RegionImageMapping_To_config_RegionImageMapping(in, out, s)
}

func autoConvert_config_RegionImageMapping_To_v1alpha1_RegionImageMapping(in *config.RegionImageMapping, out *RegionImageMapping, s conversion.Scope) error {
	out.Region = in.Region
	out.ImageID = in.ImageID
	return nil
}

// Convert_config_RegionImageMapping_To_v1alpha1_RegionImageMapping is an autogenerated conversion function.
func Convert_config_RegionImageMapping_To_v1alpha1_RegionImageMapping(in *config.RegionImageMapping, out *RegionImageMapping, s conversion.Scope) error {
	return autoConvert_config_RegionImageMapping_To_v1alpha1_RegionImageMapping(in, out, s)
}
